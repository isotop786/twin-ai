...
# Original version of call_bedrock commented out
...
# New version of call_bedrock for Bedrock compatibile format
def call_bedrock(conversation: List[Dict], user_message: str) -> str:
    messages = []
    ...
    try:
        ...
        raise HTTPException(
            status_code=400,
            detail=f"Bedrock error: {e.response['Error']['Message']}"
        )
